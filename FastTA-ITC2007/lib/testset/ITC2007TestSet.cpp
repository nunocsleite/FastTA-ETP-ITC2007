...
//            cout << *beg << " ";
            ...
            boost::unordered_map<int, vector<int> >::iterator mapIt = _studentMap.find(student);
...
/// SEE!
///
    boost::shared_ptr<AdjacencyList> ptrGraphAux(new AdjacencyList(conflictMatrix.getNumCols()));

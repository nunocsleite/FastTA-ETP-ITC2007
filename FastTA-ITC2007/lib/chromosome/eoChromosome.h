...
//     */
//    inline void setExamProximityConflicts(long _examProximityConflicts);
...
void eoChromosome::setTimetableProblemData(const TimetableProblemData *_value) {
    ...
    ///
    timetableContainer = boost::make_shared<TimetableContainerMatrix>(
                             timetableProblemData->getNumExams(),
                             timetableProblemData->getNumPeriods(),
                             timetableProblemData->getNumRooms(),
...
// * @return
// */
//double eoChromosome::getProximityCost() const {
//    return (double)examProximityConflicts / getNumStudents();
//}
///**
// * @brief getExamProximityConflicts Return exam proximity conflicts
// * @return
// */
//long eoChromosome::getProximityConflicts() const {
//    return examProximityConflicts;
//}
/**
 * @brief isFeasible
 * @return true if chromosome is feasible and false otherwise
...
// * @param _examProximityConflicts
// */
//void eoChromosome::setExamProximityConflicts(long _examProximityConflicts) {
//    examProximityConflicts = _examProximityConflicts;
//}
